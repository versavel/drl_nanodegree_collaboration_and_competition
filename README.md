...
The state space consists of 48 variables corresponding to the position and velocity of the ball, racket, and players. Each agent receives its own, local observation consisting of 24 variables.  Two continuous actions are available to each player, corresponding to movement toward (or away from) the net, and jumping. 
...
2. Place the file in the repository, in the `p3_collab-compet_maddpg/` folder, and unzip (or decompress) the file. 
